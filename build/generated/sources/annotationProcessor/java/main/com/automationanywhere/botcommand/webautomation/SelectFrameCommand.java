...
public final class SelectFrameCommand implements BotCommand {
  private static final Logger logger = LogManager.getLogger(SelectFrameCommand.class);
  ...
  public Optional<Value> execute(GlobalSessionContext globalSessionContext,
    ...
    SelectFrame command = new SelectFrame();
