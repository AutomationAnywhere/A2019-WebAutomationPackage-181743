...
public final class GetDetailsCommand implements BotCommand {
  private static final Logger logger = LogManager.getLogger(GetDetailsCommand.class);
  ...
  public Optional<Value> execute(GlobalSessionContext globalSessionContext,
    ...
    GetDetails command = new GetDetails();
    ...
    try {
      Optional<Value> result =  Optional.ofNullable(command.action((String)convertedParameters.get("sessionName"),(String)convertedParameters.get("search"),(String)convertedParameters.get("type"),(String)convertedParameters.get("filename"),(Number)convertedParameters.get("timeout"),(String)convertedParameters.get("attribute")));
