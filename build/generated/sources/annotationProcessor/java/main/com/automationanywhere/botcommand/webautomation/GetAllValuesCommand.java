...
public final class GetAllValuesCommand implements BotCommand {
  private static final Logger logger = LogManager.getLogger(GetAllValuesCommand.class);
  ...
  public Optional<Value> execute(GlobalSessionContext globalSessionContext,
    ...
    GetAllValues command = new GetAllValues();
    ...
    try {
      Optional<Value> result =  Optional.ofNullable(command.action((String)convertedParameters.get("sessionName"),(List<StringValue>)convertedParameters.get("searchList"),(String)convertedParameters.get("type")));
