...
public final class DoClickCommand implements BotCommand {
  private static final Logger logger = LogManager.getLogger(DoClickCommand.class);
  ...
  public Optional<Value> execute(GlobalSessionContext globalSessionContext,
    ...
    if(parameters.containsKey("clicktype") && parameters.get("clicktype") != null && parameters.get("clicktype").get() != null) {
      convertedParameters.put("clicktype", parameters.get("clicktype").get());
      if(convertedParameters.get("clicktype") !=null && !(convertedParameters.get("clicktype") instanceof String)) {
        throw new BotCommandException(MESSAGES_GENERIC.getString("generic.UnexpectedTypeReceived","clicktype", "String", parameters.get("clicktype").get().getClass().getSimpleName()));
      }
    }
    if(convertedParameters.get("clicktype") == null) {
      throw new BotCommandException(MESSAGES_GENERIC.getString("generic.validation.notEmpty","clicktype"));
    }
    if(convertedParameters.get("clicktype") != null) {
      switch((String)convertedParameters.get("clicktype")) {
        case "Click" : {
        ...
        default : throw new BotCommandException(MESSAGES_GENERIC.getString("generic.InvalidOption","clicktype"));
      }
    }
    ...
    try {
      command.action((String)convertedParameters.get("sessionName"),(String)convertedParameters.get("search"),(String)convertedParameters.get("type"),(String)convertedParameters.get("clicktype"),(Number)convertedParameters.get("timeout"),(String)convertedParameters.get("attribute"));Optional<Value> result = Optional.empty();
