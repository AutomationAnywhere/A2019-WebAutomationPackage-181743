...
public final class SetValueCommand implements BotCommand {
  private static final Logger logger = LogManager.getLogger(SetValueCommand.class);
  ...
  public Optional<Value> execute(GlobalSessionContext globalSessionContext,
    ...
    if(parameters.containsKey("newvalue") && parameters.get("newvalue") != null && parameters.get("newvalue").get() != null) {
      ...
      if(convertedParameters.get("newvalue") !=null && !(convertedParameters.get("newvalue") instanceof SecureString)) {
        throw new BotCommandException(MESSAGES_GENERIC.getString("generic.UnexpectedTypeReceived","newvalue", "SecureString", parameters.get("newvalue").get().getClass().getSimpleName()));
      }
    }
    ...
    try {
      command.action((String)convertedParameters.get("sessionName"),(String)convertedParameters.get("search"),(String)convertedParameters.get("type"),(SecureString)convertedParameters.get("newvalue"),(Number)convertedParameters.get("timeout"),(String)convertedParameters.get("attribute"));Optional<Value> result = Optional.empty();
